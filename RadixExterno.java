...
public class RadixExterno {
    ...
    ArrayList<Persona> persLect2 = new ArrayList<>();
    ArrayList<Persona> persLect3 = new ArrayList<>();
...
//        num6(n,list);
    ...
    public void extraer(ArrayList<Persona> list,File ar1,File ar2,File ar3,File ar4,File ar5,File ar6,File ar7,File ar8,File ar9,File ar0,File archFinal){
        ...
        int inic=0;
        System.out.println(tamAr1+" "+tamAr2+" "+tamAr3+" "+tamAr4+" "+tamAr5+" "+tamAr6+" "+tamAr7+" "+tamAr8+" "+tamAr9+" "+tamAr0);
...
//                    borrar("Cola2.txt");
                ...
                escribirArch(lectura(ar3,j),archFinal);
//                persLect.remove(0);
                tamAr3-=1;
                if(tamAr3==0){
                    borrar("Cola3.txt");
                ...
                escribirArch(lectura(ar4,j),archFinal);
//                persLect.remove(0);
                tamAr4-=1;
                if(tamAr4==0){
                    borrar("Cola4.txt");
                ...
                escribirArch(lectura(ar5,j),archFinal);
//                persLect.remove(0);
                tamAr5-=1;
                if(tamAr5==0){
                    borrar("Cola5.txt");
                ...
                escribirArch(lectura(ar6,j),archFinal);
//                persLect.remove(0);
                tamAr6-=1;
                if(tamAr6==0){
                    borrar("Cola6.txt");
                ...
                escribirArch(lectura(ar7,j),archFinal);
//                persLect.remove(0);
                tamAr7-=1;
                if(tamAr7==0){
                    borrar("Cola7.txt");
                ...
                escribirArch(lectura(ar8,j),archFinal);
//                persLect.remove(0);
                tamAr8-=1;
                if(tamAr8==0){
                    borrar("Cola8.txt");
                ...
                escribirArch(lectura(ar9,j),archFinal);
//                persLect.remove(0);
                tamAr9-=1;
                if(tamAr9==0){
                    borrar("Cola9.txt");
                ...
                escribirArch(lectura(ar0,j),archFinal);
//                persLect.remove(0);
                tamAr0-=1;
                if(tamAr0==0){
                    borrar("Cola0.txt");
    ...
    public Persona lectura(File archivo,int i) {
        ...
        System.out.println("Se retornó aaa "+persLect.get(i).getNombre()); 
